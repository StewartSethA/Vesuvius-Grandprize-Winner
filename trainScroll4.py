...
class CFG:
    ...
    train_batch_size = 64 #64 #256 # 32 # 64 is STABLE w/o NaNs!
    ...
    lr = 1e-6
    # ============== fold =============
    valid_id = '20240304141530' #'20230820203112'
...
def read_image_mask(fragment_id,start_idx=15,end_idx=45):
    ...
    if os.path.isfile(CFG.comp_dataset_path + f"train_scrolls/{fragment_id}/layers/{fragment_id}.npy"):
      ...
      for i in idxs:
        ...
        print("Loading", f"train_scrolls/{fragment_id}/layers/{i:02}.tif")
        ...
        if image is None:
          print("WARNING: FAILED TO LOAD!", f"train_scrolls/{fragment_id}/layers/{i:02}.tif")
...
def get_train_valid_dataset():
    ...
    train_ids  = set(["20240304141530", "20231210132030", "20231215151901", "20231122192640"]) #"20230702185753"]) # TODO add 640 back in once it's there!!! HOW TO TRAIN ON IT???
...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        if self.xyxys is not None:
            ...
            #print("Got image, label", image.shape)
            #print(label.shape)
            if self.transform:
...
for fid in fragments:
    ...
    trainer = pl.Trainer(
        ...
        check_val_every_n_epoch=5, #check_val_every_n_epoch,
        accumulate_grad_batches=1,
        precision='16-mixed',
        gradient_clip_val=0.0125,
